...
<link rel="stylesheet" href="<c:url value='/css/wwpass.css' />" />
...
<div class="box" id="login">
    ...
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        ...
        <c:if test="${param.wwperror != null}">
            <div id="wmsg" class="errors"><p>WWPass authentication error: ${param.wwperror}</p></div>
        </c:if>

        <section class="row">
            <!--*************** Display the login button and informational text fields ********************************-->

            <a href="#" style="margin-top: 15px; margin-left: 15px;" id="wwpass_button" onclick="javascript:OnAuth();"></a>
        ...
        <section class="row btn-row">
            ...
            <input class="btn-submit" name="_submit" accesskey="l" value="<spring:message code='screen.welcome.button.login' />" tabindex="4" type="submit" />
    ...
    <%--    <br/>
        ...
        <p><a href="#" style="margin-left: 135px;">Register</a></p>--%>
    ...
    function OnAuth() {
        wwpass_auth('<spring:eval expression="@wwpassSpName"/>', function (status, response) {
            if (status == WWPass_OK) { //If ticket request handled successfully
                ...
                f.submit();
            } else if(status == WWPass_USER_REJECT) {
                // do nothing
            } else {
                document.location = document.location.toString().replace("#", "&wwperror=" + response); //If ticket request not handled, return error
            }
        });
        return false;
    }
